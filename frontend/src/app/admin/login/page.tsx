        ...
        <form onSubmit={(e) => void handleSubmit(e)} className="mt-8 space-y-4">
          ...
          <div>
            ...
            <PasswordInput
              ...
              disabled={isSubmitting}
              className="w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3 py-2.5 text-white outline-none focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-violet-500"
            />
          </div>
